...
angular.module("multiselect.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("multiselect.tpl.html", 
      ...
      "    <span>{{header}}</span> <span class=\"caret\"></span>\n" +
      "  </button>\n" +
      "  <ul class=\"dropdown-menu\" style=\"margin-bottom:30px;padding-left:5px;padding-right:5px;\" ng-style=\"ulStyle\">\n" +
      "    <li>\n" +
      "        <input class=\"input-block-level\" type=\"text\" style=\"width:100%\" ng-model=\"searchText.label\" autofocus=\"autofocus\" placeholder=\"Buscar\" />\n" +
      "    </li>\n" +
      "     <li ng-show=\"multiple\">\n " + 
      "        <button class=\"btn-link btn-small\" type=\"button\" ng-click=\"checkAll()\"><i class=\"glyphicon glyphicon-ok\"></i> Marcar Todos</button>\n " +
      "        <button class=\"btn-link btn-small\" type=\"button\" ng-click=\"uncheckAll()\"><i class=\"glyphicon glyphicon-remove\"></i> Desmarcar Todos</button>\n " +
      "     </li> \n" +
